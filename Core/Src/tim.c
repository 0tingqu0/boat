...
volatile uint16_t Rpwm_in1 = 0; // 595--675 80 0.8 665 7.3
volatile uint16_t Rpwm_in2 = 0; // 595--675 80 0.8 665 7.3
volatile uint16_t Lpwm_in1 = 0; // 595--675 80 0.8 665 7.3
volatile uint16_t Lpwm_in2 = 0; // 595--675 80 0.8 665 7.3
